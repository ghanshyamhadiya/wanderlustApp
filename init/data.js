const sampleListings = [
  ...
  },
  {
    ...
    location: 'Aspen',
    country: 'United States',
    geometry: { type: 'Point', coordinates: [ -106.819214, 39.19068 ] }
  },
  {
  ...
  },
  {
    ...
    location: 'Portland',
    country: 'United States',
    geometry: { type: 'Point', coordinates: [ -122.67837, 45.515198 ] }
  },
  {
  ...
  },
  {
    ...
    location: 'Lake Tahoe',
    country: 'United States',
    geometry: { type: 'Point', coordinates: [ -94.032465, 29.965875 ] }
  },
  {
    ...
    country: 'United States',
    geometry: { type: 'Point', coordinates: [ -118.25419, 34.04805 ] }
  },
  {
  ...
  },
  {
    ...
    location: 'Fiji',
    country: 'Fiji',
    geometry: { type: 'Point', coordinates: [ 120.782906, 23.831717 ] }
  },
  {
  ...
  },
  {
    ...
    country: 'United Kingdom',
    geometry: { type: 'Point', coordinates: [ 1.22089, 52.658908 ] }
  },
  {
  ...
  },
  {
    ...
    location: 'Costa Rica',
    country: 'Costa Rica',
    geometry: { type: 'Point', coordinates: [ -107.399481, 24.583981 ] }
  },
  {
...
//   const mapToken = 'pk.eyJ1Ijoia2F1c2hpazA0IiwiYSI6ImNtNHp2bmN4bTE4dDYyanNleXY0bDFxYm0ifQ.76a6VrKOTmEviMRsZ9vlOA';
...
//         const coordinates = response.body.features[0].geometry.coordinates; // [lng, lat]
//         return coordinates;
//     } catch (error) {
...
//             };
//         } else {
//             // Fallback coordinates if geocoding fails (e.g., [0, 0])
//             listing.geometry = {
//                 type: "Point",
//                 coordinates: [0, 0],
//             };
...
// // Use an immediately invoked async function to handle the async export
// (async () => {
//     try {
//         await updateListingsWithGeometry();
//         // Log the listings with full details using console.dir or JSON.stringify
//         console.dir(sampleListings, { depth: null }); // Shows full nested structure
//         // Alternatively: console.log(JSON.stringify(sampleListings, null, 2));
//         module.exports = { data: sampleListings };
//     } catch (error) {
//         console.error("Error updating listings:", error);
//         module.exports = { data: sampleListings }; // Export even if there's an error
//     }
// })();
